...
const LoginPage = () => {
  ...
  return (
    ...
    justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
        {/* ------- left side ------- */}
        <img src={assets.logo_big} alt="" className="w-32 sm:w-40 md:w-48 lg:w-56"/>  {/*'w-[min(30vw, 250px)]'*/}
        ...
        flex-col gap-6 rounded-lg shadow-lg'>
            ...
            <button type='s' className='py-3 bg-gradient-to-r from-purple-400
            to-violet-600 text-white rounded-md currsor-pointer'>
